...
$envLines = @(
    ...
    "ARB_SELF_TUNE=true",
    "ARB_SELF_TUNE_MAX_CHANGES_PER_DAY=15"
)
...
Write-Host " BOT IS RUNNING (realistic paper — CLOB verified, live-parity)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
